...
export default function CreateAuctionPage() {
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({
      ...prev,
      auctionStartTime: timestamp.toString(),
    }));
  }, []);
  ...
  const createAuction = async () => {
    ...
    try {
      ...
      const askLoanData = {
        ...
        initialCollateralAmount: ethers.parseEther(
          formData.collateralInitialDeposit
        ), // Assuming ETH (18 decimals)
      };

      const collateralInitialDeposit = ethers.parseEther(
        formData.collateralInitialDeposit
      );
      ...
      if (auctionCreatedEvent) {
        const parsedEvent =
          auctionFactory.interface.parseLog(auctionCreatedEvent);
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Set up your lending terms and start an auction
          </p>
          <Link
            href="/"
          ...
          <>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure your bond auction parameters
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Alert>
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    <strong>Important:</strong> Make sure the AuctionFactory
                    contract address is configured correctly and that your
                    tokens are whitelisted in the factory before creating an
                    auction.
                  </AlertDescription>
                </Alert>
              </CardContent>
